...
if ('serviceWorker' in navigator) {
  ...
  log('serviceWorker in navigator')
    ...
    navigator.serviceWorker.ready.then(function (registration) {
        ...
        return registration.pushManager.getSubscription().then(function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(subscription) {
...
if (JSON.parse(getCookie("loggedin")) === true&&!servicew||condition === "online") {
    console.log("using saved data", "background:green;");
    console.log(JSON.parse(localsave("userdata", "get")));
    username = JSON.parse(localsave("userdata", "get")).name;
    socket.emit("login attempt", {
